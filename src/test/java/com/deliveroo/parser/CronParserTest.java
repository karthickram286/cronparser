...
class CronParserTest {
    ...
    @Test
    public void test1() throws InvalidCronFieldException, InvalidCronStringException {
    ...
    @Test
    public void test2() throws InvalidCronFieldException, InvalidCronStringException {
    ...
    @Test
    public void test3() throws InvalidCronFieldException, InvalidCronStringException {
        CronExpressionParser cronExpressionParser = new CronExpressionParser("*/3,3/4 * 31 3,SEP * /usr/bin/find");
        cronExpressionParser.parse();
        System.out.println(cronExpressionParser);
    }
